...
{
    /// <summary>
    /// Inserta un nuevo envío en la persistencia de datos.
    /// </summary>
    /// <param name="envio">El objeto Envio a registrar.</param>
    void Agregar(Envio envio);

    /// <summary>
    /// Actualiza las propiedades de un envío existente en el almacenamiento.
    /// </summary>
    /// <param name="envio">El objeto Envio con los datos modificados.</param>
    void Actualizar(Envio envio);

    /// <summary>
    /// Remueve un registro de envío del sistema de almacenamiento.
    /// </summary>
    /// <param name="envio">El objeto Envio que se desea eliminar.</param>
    void Eliminar(Envio envio);

    /// <summary>
    /// Recupera un envío específico buscando por su identificador único (Número de Guía).
    /// </summary>
    ...
    /// <summary>
    /// Extrae la totalidad de los envíos registrados en el sistema de almacenamiento.
    /// </summary>
    /// <returns>Una lista de objetos que heredan de la clase base Envio.</returns>
    List<Envio> ObtenerTodos();

    /// <summary>
    /// Filtra la colección de envíos basándose en una expresión condicional lógica.
    /// </summary>
    ...
    /// <summary>
    /// Ordena la colección de envíos basándose en una propiedad o criterio específico.
    /// </summary>
    ...
    /// <summary>
    /// Busca el primer envío que cumpla de manera exacta con una condición lógica.
    /// </summary>
